...
package alimentation_data_warehouse.jdwhclient_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jDwhClient = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jDwhClient) {
...
updateBICurrent_tmp.ID_DIM_CLIENT = row3.ID_DIM_CLIENT ;
...
pstmt_tDBOutput_2.setTimestamp(1, new java.sql.Timestamp(updateBICurrent.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(2, updateBICurrent.BL_LIGNE_ACTIVE);

                    pstmt_tDBOutput_2.setInt(3 + count_tDBOutput_2, updateBICurrent.ID_DIM_CLIENT);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(clients,row3) outputs:(insertClient,updateBICurrent,insertNewClient)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jDwhClient.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jdwhclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     258132 characters generated by Talend Open Studio for Data Integration 
