...
package alimentation_data_warehouse.jdwhproduit_0_1;
...
/**
 * Job: jDwhProduit Purpose: Alimentation de la table DIM_CLIENT<br>
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jDwhProduit) {
...
if(dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
	...
	tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("DIM_PRODUIT");
        ...
        } else if (updateKeyCount_tDBOutput_2 == 13 && true) {        
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"CD_PRODUIT\" = ?,\"NOM_PRODUIT\" = ?,\"PRIX_ACHAT_PRODUIT\" = ?,\"PRIX_VENTE_PRODUIT\" = ?,\"CD_SOUS_CATEGORIE\" = ?,\"LB_SOUS_CATEGORIE\" = ?,\"CD_CATEGORIE\" = ?,\"LB_CATEGORIE\" = ?,\"DT_INSERTION\" = ?,\"DT_MISE_A_JOUR\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"ID_DIM_PRODUIT\" = ?";
...
int count_tDBOutput_3=0;
	    String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"PRIX_ACHAT_PRODUIT\",\"PRIX_VENTE_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"DT_INSERTION\",\"DT_MISE_A_JOUR\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
...
|| Produits.PRIX_ACHAT_PRODUIT.compareTo(row4.PRIX_ACHAT_PRODUIT)!=0
|| Produits.PRIX_VENTE_PRODUIT.compareTo(row4.PRIX_VENTE_PRODUIT)!=0

 ) {
updateBICurrent_tmp.ID_DIM_PRODUIT = row4.ID_DIM_PRODUIT ;
updateBICurrent_tmp.CD_PRODUIT = null;
...
updateBICurrent_tmp.DT_MISE_A_JOUR = TalendDate.getCurrentDate();
...
} else {pstmt_tDBOutput_2.setString(1, updateBICurrent.CD_PRODUIT);
}

                    if(updateBICurrent.NOM_PRODUIT == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, updateBICurrent.NOM_PRODUIT);
}

                    pstmt_tDBOutput_2.setBigDecimal(3, updateBICurrent.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_2.setBigDecimal(4, updateBICurrent.PRIX_VENTE_PRODUIT);

                    if(updateBICurrent.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, updateBICurrent.CD_SOUS_CATEGORIE);
}

                    if(updateBICurrent.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, updateBICurrent.LB_SOUS_CATEGORIE);
}

                    if(updateBICurrent.CD_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, updateBICurrent.CD_CATEGORIE);
}

                    if(updateBICurrent.LB_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, updateBICurrent.LB_CATEGORIE);
}

                    if(updateBICurrent.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(9, new java.sql.Timestamp(updateBICurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.TIMESTAMP);
}

                    if(updateBICurrent.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_2.setTimestamp(10, new java.sql.Timestamp(updateBICurrent.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_2.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(11, updateBICurrent.BL_LIGNE_ACTIVE);

                    if(updateBICurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(12, updateBICurrent.LB_JOB_NAME);
}

                    pstmt_tDBOutput_2.setInt(13 + count_tDBOutput_2, updateBICurrent.ID_DIM_PRODUIT);
...
} else {pstmt_tDBOutput_3.setString(1, insertNewProduit.CD_PRODUIT);
}

                    if(insertNewProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertNewProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_3.setBigDecimal(3, insertNewProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_3.setBigDecimal(4, insertNewProduit.PRIX_VENTE_PRODUIT);

                    if(insertNewProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, insertNewProduit.CD_SOUS_CATEGORIE);
}

                    if(insertNewProduit.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, insertNewProduit.LB_SOUS_CATEGORIE);
}

                    if(insertNewProduit.CD_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, insertNewProduit.CD_CATEGORIE);
}

                    if(insertNewProduit.LB_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, insertNewProduit.LB_CATEGORIE);
}

                    if(insertNewProduit.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(9, new java.sql.Timestamp(insertNewProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.TIMESTAMP);
}

                    if(insertNewProduit.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(insertNewProduit.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(11, insertNewProduit.BL_LIGNE_ACTIVE);

                    if(insertNewProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(12, insertNewProduit.LB_JOB_NAME);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(Produits,row4) outputs:(insertProduit,updateBICurrent,insertNewProduit)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jDwhProduit.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jdwhproduit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     293369 characters generated by Talend Open Studio for Data Integration 
 *     on the June 5, 2025 at 1:18:25 PM BST
 ************************************************************************************************/