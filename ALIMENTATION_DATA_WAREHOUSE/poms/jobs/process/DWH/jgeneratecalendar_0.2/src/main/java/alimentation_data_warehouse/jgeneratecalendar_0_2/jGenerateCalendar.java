...
package alimentation_data_warehouse.jgeneratecalendar_0_2;
...
public class jGenerateCalendar implements TalendJob {
	...
	public static class row_Implicit_Context_DatabaseStruct
		...
		final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar = new byte[0];
		static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar.length) {
					if (length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar.length == 0) {
						commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar = new byte[1024];
					} else {
						commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar, 0, length);
				strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar, 0, length);
				strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jGenerateCalendar) {
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String sharedConnectionName_tDBConnection_1 = "VENTE_DWH";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:+zJeLarxtM+5+Hr0/QLfPNT9cikYi4ayA55VYg==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/pc/Downloads/joursFeries.xlsx";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jGenerateCalendar.class.getClassLoader().getResourceAsStream(
					"alimentation_data_warehouse/jgeneratecalendar_0_2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 180219 characters generated by Talend Open Studio for Data Integration on the
 * June 5, 2025 at 11:53:45 AM BST
 ************************************************************************************************/