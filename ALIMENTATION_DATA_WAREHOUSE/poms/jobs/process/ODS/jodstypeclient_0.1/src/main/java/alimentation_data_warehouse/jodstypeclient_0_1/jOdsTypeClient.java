...
package alimentation_data_warehouse.jodstypeclient_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsTypeClient) {
...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"LB_TYPE_CLIENT\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_TYPE_CLIENT\" = ?";
...
CATEGORIE_tmp.LB_TYPE_CLIENT = row1.LB_TYPE_CLIENT ;
...
!CATEGORIE.CD_TYPE_CLIENT.isEmpty() && !CATEGORIE.LB_TYPE_CLIENT.isEmpty()			), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.LB_TYPE_CLIENT = CATEGORIE.LB_TYPE_CLIENT;
      ...
      nb_line_ok_tFilterRow_1++;
            ...
            if (row5 == null){
              row5 = new row5Struct();
                ...
                row5.LB_TYPE_CLIENT = CATEGORIE.LB_TYPE_CLIENT;
...
updateBICurrent_tmp.LB_TYPE_CLIENT = null;
...
} else {pstmt_tDBOutput_3.setString(1, insertTypeClient.CD_TYPE_CLIENT);
}

                    if(insertTypeClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertTypeClient.LB_TYPE_CLIENT);
}

                    if(insertTypeClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertTypeClient.LB_NOM_FICHIER);
}

                    if(insertTypeClient.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(4, new java.sql.Timestamp(insertTypeClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(5, insertTypeClient.BL_LIGNE_ACTIVE);

                    if(insertTypeClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, insertTypeClient.LB_JOB_NAME);
}
...
if(updateBICurrent != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    if(updateBICurrent.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(1, updateBICurrent.LB_TYPE_CLIENT);
}

                    if(updateBICurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, updateBICurrent.LB_NOM_FICHIER);
}

                    if(updateBICurrent.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(3, new java.sql.Timestamp(updateBICurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(4, updateBICurrent.BL_LIGNE_ACTIVE);

                    if(updateBICurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(5, updateBICurrent.LB_JOB_NAME);
}

                    if(updateBICurrent.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(6 + count_tDBOutput_1, updateBICurrent.CD_TYPE_CLIENT);
}
...
} else {pstmt_tDBOutput_2.setString(1, insertNewValueTypeClient.CD_TYPE_CLIENT);
}

                    if(insertNewValueTypeClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertNewValueTypeClient.LB_TYPE_CLIENT);
}

                    if(insertNewValueTypeClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, insertNewValueTypeClient.LB_NOM_FICHIER);
}

                    if(insertNewValueTypeClient.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(insertNewValueTypeClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(5, insertNewValueTypeClient.BL_LIGNE_ACTIVE);

                    if(insertNewValueTypeClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, insertNewValueTypeClient.LB_JOB_NAME);
}
...
insertRejet_tmp.LB_LIGNE_REJET = row5.CD_TYPE_CLIENT+'|'+row5.LB_TYPE_CLIENT ;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsTypeClient.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jodstypeclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     322929 characters generated by Talend Open Studio for Data Integration 
