...
package alimentation_data_warehouse.jodsvente_0_1;
...
private class TalendException extends Exception {
	...
	public void printStackTrace() {
		...
		try {
			...
			public void tChronometerStart_2_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tChronometerStart_2_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsVente) {
...
Long startTime = (Long) globalMap.get("tChronometerStart_1_STARTTIME");

if (startTime != null) {
    System.out.println("Début d'exécution du job " + jobName + "        : " +
        TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", new java.util.Date(startTime))
    );
} else {
    System.out.println("Début d'exécution du job " + jobName + "        : N/A (start time not available)");
}
 ...
 */
	...
	System.err.println("Le repertoir" + TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Categorie. Veuillez desposer le fichier du jour et relancer l'integration");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "Le repertoir" + TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Categorie. Veuillez desposer le fichier du jour et relancer l'integration");
	globalMap.put("tDie_1_DIE_MESSAGES", "Le repertoir" + TalendDate.getDate("YYYYMMDD")+ " ne contient pas de fichier Categorie. Veuillez desposer le fichier du jour et relancer l'integration");
...
public static class verifiantClientStruct implements routines.system.IPersistableRow<verifiantClientStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(verifiantClientStruct other) {
...
public static class clientInexistantStruct implements routines.system.IPersistableRow<clientInexistantStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsVente = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final clientInexistantStruct other = (clientInexistantStruct) obj;
	...
	public void copyDataTo(clientInexistantStruct other) {
	...
	public void copyKeysDataTo(clientInexistantStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(clientInexistantStruct other) {
...
verifiantClientStruct verifiantClient = new verifiantClientStruct();
insertVenteStruct insertVente = new insertVenteStruct();
venteExistantStruct venteExistant = new venteExistantStruct();
clientInexistantStruct clientInexistant = new clientInexistantStruct();
...
if(dbschema_tDBOutput_7 == null || dbschema_tDBOutput_7.trim().length() == 0) {
	tableName_tDBOutput_7 = ("ODS_VENTE");
} else {
	tableName_tDBOutput_7 = dbschema_tDBOutput_7 + "\".\"" + ("ODS_VENTE");
}
...
int count_tDBOutput_7=0;
	    String insert_tDBOutput_7 = "INSERT INTO \"" + tableName_tDBOutput_7 + "\" (\"ID_VENTE\",\"CD_PRODUIT\",\"DT_VENTE\",\"ID_CLIENT\",\"QTE_VENTE\",\"PRIX_ACHAT\",\"PRIX_VENTE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\",\"BL_LIGNE_IN_DWH\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
 ...
 */
	...
	currentComponent="tMap_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"verifiantClient");
					}
 ...
 */
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"clientInexistant");
					}
...
// ###############################
// # Outputs initialization
verifiantClientStruct verifiantClient_tmp = new verifiantClientStruct();
clientInexistantStruct clientInexistant_tmp = new clientInexistantStruct();
// ###############################
...
!Vente.CD_PRODUIT.isEmpty() && !Vente.ID_VENTE.isEmpty() && !Vente.ID_CLIENT.isEmpty() && Vente.DT_VENTE != null && Vente.PRIX_VENTE != null && Vente.PRIX_ACHAT != null && Vente.QTE_VENTE != null), "advanced condition failed");
...
sousCategorie_tmp.ID_VENTE = row3.ID_VENTE ;
sousCategorie_tmp.CD_PRODUIT = row3.CD_PRODUIT ;
sousCategorie_tmp.DT_VENTE = row3.DT_VENTE ;
sousCategorie_tmp.ID_CLIENT = row3.ID_CLIENT ;
sousCategorie_tmp.QTE_VENTE = row3.QTE_VENTE ;
sousCategorie_tmp.PRIX_ACHAT = row3.PRIX_ACHAT ;
sousCategorie_tmp.PRIX_VENTE = row3.PRIX_VENTE ;
...
categorieManquant_tmp.LB_LIGNE_REJET = row3.ID_VENTE +'|'+ row3.CD_PRODUIT +'|'+ row3.DT_VENTE +'|'+ row3.ID_CLIENT  +'|'+ row3.QTE_VENTE +'|'+ row3.PRIX_ACHAT  +'|'+row3.PRIX_VENTE ;
categorieManquant_tmp.LB_MESSAGE_REJET = "Depandance ==> le produit: "+row3.CD_PRODUIT +" n'existe pas" ;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.ID_CLIENT = sousCategorie.ID_CLIENT ;
...
verifiantClient = null;
clientInexistant = null;

if(!rejectedInnerJoin_tMap_5 ) {

// # Output table : 'verifiantClient'
verifiantClient_tmp.ID_VENTE = sousCategorie.ID_VENTE ;
verifiantClient_tmp.CD_PRODUIT = sousCategorie.CD_PRODUIT ;
verifiantClient_tmp.DT_VENTE = sousCategorie.DT_VENTE ;
verifiantClient_tmp.ID_CLIENT = sousCategorie.ID_CLIENT ;
verifiantClient_tmp.QTE_VENTE = sousCategorie.QTE_VENTE ;
verifiantClient_tmp.PRIX_ACHAT = sousCategorie.PRIX_ACHAT ;
verifiantClient_tmp.PRIX_VENTE = sousCategorie.PRIX_VENTE ;
verifiantClient_tmp.NUM_LIGNE = sousCategorie.NUM_LIGNE ;
verifiantClient = verifiantClient_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'clientInexistant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
clientInexistant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
clientInexistant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
clientInexistant_tmp.NUM_LIGNE_REJET = sousCategorie.NUM_LIGNE ;
clientInexistant_tmp.LB_LIGNE_REJET = sousCategorie.ID_VENTE +'|'+  sousCategorie.CD_PRODUIT +'|'+ sousCategorie.DT_VENTE	+'|'+
sousCategorie.ID_CLIENT +'|'+ sousCategorie.QTE_VENTE	+'|'+
sousCategorie.PRIX_ACHAT +'|'+
sousCategorie.PRIX_VENTE ;
clientInexistant_tmp.LB_MESSAGE_REJET = "Depandance ==> l'identifiant client: "+ sousCategorie.ID_CLIENT+ " n'existe pas" ;
clientInexistant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
clientInexistant_tmp.DT_REJET = TalendDate.getCurrentDate();
clientInexistant_tmp.LB_JOB_NAME = jobName;
clientInexistant = clientInexistant_tmp;
} // closing filter/reject
// ###############################
 ...
 */
// Start of branch "verifiantClient"
if(verifiantClient != null) { 
 					    ...
 					    boolean forceLooprow8 = false;
 							...
 							row8Struct row8ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_6 = false;
                        		    		    ...
                        		    		    row8HashKey.ID_VENTE = verifiantClient.ID_VENTE ;
                        		    		
                        		    		    row8HashKey.CD_PRODUIT = verifiantClient.CD_PRODUIT ;
								  ...
								  if(!tHash_Lookup_row8.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row8 != null && tHash_Lookup_row8.getCount(row8HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.ID_VENTE = '" + row8HashKey.ID_VENTE + "', row8.CD_PRODUIT = '" + row8HashKey.CD_PRODUIT + "'");
								} // G 071
...
venteExistant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
venteExistant_tmp.NUM_LIGNE_REJET = verifiantClient.NUM_LIGNE ;
venteExistant_tmp.LB_LIGNE_REJET = verifiantClient.ID_VENTE  +'|'+verifiantClient.CD_PRODUIT +'|'+ verifiantClient.DT_VENTE  +'|'+verifiantClient.ID_CLIENT  +'|'+verifiantClient.QTE_VENTE  +'|'+verifiantClient.PRIX_ACHAT +'|'+ verifiantClient.PRIX_VENTE ;
venteExistant_tmp.LB_MESSAGE_REJET = "Donnée deja inserer dans la table" ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_6 ) {
insertVente_tmp.ID_VENTE = verifiantClient.ID_VENTE ;
insertVente_tmp.CD_PRODUIT = verifiantClient.CD_PRODUIT ;
insertVente_tmp.DT_VENTE = verifiantClient.DT_VENTE ;
insertVente_tmp.ID_CLIENT = verifiantClient.ID_CLIENT ;
insertVente_tmp.QTE_VENTE = verifiantClient.QTE_VENTE ;
insertVente_tmp.PRIX_ACHAT = verifiantClient.PRIX_ACHAT ;
insertVente_tmp.PRIX_VENTE = verifiantClient.PRIX_VENTE ;
...
} else {pstmt_tDBOutput_7.setString(1, insertVente.ID_VENTE);
}

                    if(insertVente.CD_PRODUIT == null) {
pstmt_tDBOutput_7.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_7.setString(2, insertVente.CD_PRODUIT);
}

                    if(insertVente.DT_VENTE != null) {
pstmt_tDBOutput_7.setTimestamp(3, new java.sql.Timestamp(insertVente.DT_VENTE.getTime()));
} else {
...
} else {pstmt_tDBOutput_7.setString(4, insertVente.ID_CLIENT);
}

                    pstmt_tDBOutput_7.setInt(5, insertVente.QTE_VENTE);

                    pstmt_tDBOutput_7.setBigDecimal(6, insertVente.PRIX_ACHAT);

                    pstmt_tDBOutput_7.setBigDecimal(7, insertVente.PRIX_VENTE);

                    if(insertVente.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_7.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_7.setString(8, insertVente.LB_NOM_FICHIER);
}

                    if(insertVente.DT_INSERTION != null) {
pstmt_tDBOutput_7.setTimestamp(9, new java.sql.Timestamp(insertVente.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_7.setString(10, insertVente.LB_JOB_NAME);
}

                    pstmt_tDBOutput_7.setBoolean(11, insertVente.BL_LIGNE_IN_DWH);
...
} else {pstmt_tDBOutput_3.setString(1, venteExistant.LB_CHEMIN_FICHIER);
}

                    if(venteExistant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, venteExistant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_3.setInt(3, venteExistant.NUM_LIGNE_REJET);

                    if(venteExistant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, venteExistant.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_3.setString(1, venteExistant.LB_MESSAGE_REJET);
}

                        if(venteExistant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(2, venteExistant.LB_NOM_FLUX);
}

                        if(venteExistant.DT_REJET != null) {
pstmtUpdate_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(venteExistant.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_3.setString(4, venteExistant.LB_JOB_NAME);
}

                        if(venteExistant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(5 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(5 + count_tDBOutput_3, venteExistant.LB_CHEMIN_FICHIER);
}

                        if(venteExistant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_3.setNull(6 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(6 + count_tDBOutput_3, venteExistant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_3.setInt(7 + count_tDBOutput_3, venteExistant.NUM_LIGNE_REJET);

                        if(venteExistant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_3.setNull(8 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_3.setString(8 + count_tDBOutput_3, venteExistant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_3.setString(1, venteExistant.LB_CHEMIN_FICHIER);
}

                        if(venteExistant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(2, venteExistant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_3.setInt(3, venteExistant.NUM_LIGNE_REJET);

                        if(venteExistant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(4, venteExistant.LB_LIGNE_REJET);
}

                        if(venteExistant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(5, venteExistant.LB_MESSAGE_REJET);
}

                        if(venteExistant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_3.setString(6, venteExistant.LB_NOM_FLUX);
}

                        if(venteExistant.DT_REJET != null) {
pstmtInsert_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(venteExistant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_3.setString(8, venteExistant.LB_JOB_NAME);
}
...
} // End of branch "verifiantClient"




// Start of branch "clientInexistant"
if(clientInexistant != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(clientInexistant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, clientInexistant.LB_CHEMIN_FICHIER);
}

                    if(clientInexistant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, clientInexistant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_2.setInt(3, clientInexistant.NUM_LIGNE_REJET);

                    if(clientInexistant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, clientInexistant.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_2 > 0) {
                        if(clientInexistant.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(1, clientInexistant.LB_MESSAGE_REJET);
}

                        if(clientInexistant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2, clientInexistant.LB_NOM_FLUX);
}

                        if(clientInexistant.DT_REJET != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(clientInexistant.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(clientInexistant.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(4, clientInexistant.LB_JOB_NAME);
}

                        if(clientInexistant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(5 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(5 + count_tDBOutput_2, clientInexistant.LB_CHEMIN_FICHIER);
}

                        if(clientInexistant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2, clientInexistant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2, clientInexistant.NUM_LIGNE_REJET);

                        if(clientInexistant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(8 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(8 + count_tDBOutput_2, clientInexistant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, clientInexistant.LB_CHEMIN_FICHIER);
}

                        if(clientInexistant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, clientInexistant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_2.setInt(3, clientInexistant.NUM_LIGNE_REJET);

                        if(clientInexistant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, clientInexistant.LB_LIGNE_REJET);
}

                        if(clientInexistant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(5, clientInexistant.LB_MESSAGE_REJET);
}

                        if(clientInexistant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(6, clientInexistant.LB_NOM_FLUX);
}

                        if(clientInexistant.DT_REJET != null) {
pstmtInsert_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(clientInexistant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_2.setString(8, clientInexistant.LB_JOB_NAME);
}
...
} // End of branch "clientInexistant"
...
// # Output table : 'insertRejet'
insertRejet_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
insertRejet_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertRejet_tmp.NUM_LIGNE_REJET = row5.NUM_LIGNE ;
insertRejet_tmp.LB_LIGNE_REJET = row5.ID_VENTE +'|'+row5.CD_PRODUIT  +'|'+row5.DT_VENTE +'|'+ row5.ID_CLIENT  +'|'+row5.QTE_VENTE +'|'+ row5.PRIX_ACHAT +'|'+ row5.PRIX_VENTE ;
insertRejet_tmp.LB_MESSAGE_REJET = "Valeurs nulles pour certain colonnes";
insertRejet_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
...
} else {pstmt_tDBOutput_4.setString(1, insertRejet.LB_CHEMIN_FICHIER);
}

                    if(insertRejet.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, insertRejet.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_4.setInt(3, insertRejet.NUM_LIGNE_REJET);

                    if(insertRejet.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(4, insertRejet.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_4.setString(1, insertRejet.LB_MESSAGE_REJET);
}

                        if(insertRejet.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(2, insertRejet.LB_NOM_FLUX);
}

                        if(insertRejet.DT_REJET != null) {
pstmtUpdate_tDBOutput_4.setTimestamp(3, new java.sql.Timestamp(insertRejet.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_4.setString(4, insertRejet.LB_JOB_NAME);
}

                        if(insertRejet.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_4.setNull(5 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(5 + count_tDBOutput_4, insertRejet.LB_CHEMIN_FICHIER);
}

                        if(insertRejet.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_4.setNull(6 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(6 + count_tDBOutput_4, insertRejet.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_4.setInt(7 + count_tDBOutput_4, insertRejet.NUM_LIGNE_REJET);

                        if(insertRejet.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_4.setNull(8 + count_tDBOutput_4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_4.setString(8 + count_tDBOutput_4, insertRejet.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_4.setString(1, insertRejet.LB_CHEMIN_FICHIER);
}

                        if(insertRejet.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(2, insertRejet.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_4.setInt(3, insertRejet.NUM_LIGNE_REJET);

                        if(insertRejet.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_4.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(4, insertRejet.LB_LIGNE_REJET);
}

                        if(insertRejet.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(5, insertRejet.LB_MESSAGE_REJET);
}

                        if(insertRejet.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_4.setString(6, insertRejet.LB_NOM_FLUX);
}

                        if(insertRejet.DT_REJET != null) {
pstmtInsert_tDBOutput_4.setTimestamp(7, new java.sql.Timestamp(insertRejet.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_4.setString(8, insertRejet.LB_JOB_NAME);
}
...
// ###############################      
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"verifiantClient");
			  	}
 ...
 */
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"clientInexistant");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(sousCategorie,categorieManquant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(sousCategorie,row7) outputs:(verifiantClient,clientInexistant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row8";
		...
		int tos_count_tAdvancedHash_row8 = 0;
			   		...
			   		// linked node: tMap_6 - inputs:(verifiantClient,row8) outputs:(insertVente,venteExistant)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsVente.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jodsvente_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     481459 characters generated by Talend Open Studio for Data Integration 
 *     on the June 5, 2025 at 1:18:24 PM BST
 ************************************************************************************************/