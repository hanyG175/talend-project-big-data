...
package alimentation_data_warehouse.jodsclient_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsClient = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsClient) {
...
public static class TypeClientInnexistantStruct implements routines.system.IPersistableRow<TypeClientInnexistantStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsClient = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final TypeClientInnexistantStruct other = (TypeClientInnexistantStruct) obj;
	...
	public void copyDataTo(TypeClientInnexistantStruct other) {
	...
	public void copyKeysDataTo(TypeClientInnexistantStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(TypeClientInnexistantStruct other) {
...
TypeClientInnexistantStruct TypeClientInnexistant = new TypeClientInnexistantStruct();
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"TypeClientInnexistant");
					}
...
TypeClientInnexistantStruct TypeClientInnexistant_tmp = new TypeClientInnexistantStruct();
// ###############################
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 2;
							...
							row1.PRENOM_CLIENT = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
CATEGORIE_tmp.ID_CLIENT = row1.ID_CLIENT ;
CATEGORIE_tmp.NOM_CLIENT = row1.NOM_CLIENT ;
CATEGORIE_tmp.PREN_CLIENT = row1.PRENOM_CLIENT ;
CATEGORIE_tmp.CD_POSTAL_CLIENT = row1.CD_POSTAL_CLIENT ;
CATEGORIE_tmp.VILLE_CLIENT = row1.VILLE_CLIENT ;
CATEGORIE_tmp.PAYS_CLIENT = row1.PAYS_CLIENT ;
CATEGORIE_tmp.REGION_CLIENT = row1.REGION_CLIENT ;
CATEGORIE_tmp.CD_TYPE_CLIENT = row1.CD_TYPE_CLIENT ;
...
!CATEGORIE.ID_CLIENT.isEmpty() && !CATEGORIE.NOM_CLIENT.isEmpty() &&!CATEGORIE.PREN_CLIENT.isEmpty() && !CATEGORIE.VILLE_CLIENT.isEmpty() && !CATEGORIE.PAYS_CLIENT.isEmpty()&& !CATEGORIE.REGION_CLIENT.isEmpty() && !CATEGORIE.CD_TYPE_CLIENT.isEmpty()), "advanced condition failed");
    
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
                row2 = new row2Struct();
              }
               row2.ID_CLIENT = CATEGORIE.ID_CLIENT;
               row2.NOM_CLIENT = CATEGORIE.NOM_CLIENT;
               row2.PREN_CLIENT = CATEGORIE.PREN_CLIENT;
               row2.CD_POSTAL_CLIENT = CATEGORIE.CD_POSTAL_CLIENT;
               row2.VILLE_CLIENT = CATEGORIE.VILLE_CLIENT;
               row2.PAYS_CLIENT = CATEGORIE.PAYS_CLIENT;
               row2.REGION_CLIENT = CATEGORIE.REGION_CLIENT;
               row2.CD_TYPE_CLIENT = CATEGORIE.CD_TYPE_CLIENT;
      ...
      nb_line_ok_tFilterRow_1++;
            ...
            if (row5 == null){
              row5 = new row5Struct();
                ...
                row5.ID_CLIENT = CATEGORIE.ID_CLIENT;
                row5.NOM_CLIENT = CATEGORIE.NOM_CLIENT;
                row5.PREN_CLIENT = CATEGORIE.PREN_CLIENT;
                row5.CD_POSTAL_CLIENT = CATEGORIE.CD_POSTAL_CLIENT;
                row5.VILLE_CLIENT = CATEGORIE.VILLE_CLIENT;
                row5.PAYS_CLIENT = CATEGORIE.PAYS_CLIENT;
                row5.REGION_CLIENT = CATEGORIE.REGION_CLIENT;
                row5.CD_TYPE_CLIENT = CATEGORIE.CD_TYPE_CLIENT;
...
client = null;
TypeClientInnexistant = null;

if(!rejectedInnerJoin_tMap_2 ) {

// # Output table : 'client'
client_tmp.ID_CLIENT = row3.ID_CLIENT ;
client_tmp.NOM_CLIENT = row3.NOM_CLIENT ;
client_tmp.PREN_CLIENT = row3.PREN_CLIENT ;
client_tmp.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT ;
client_tmp.VILLE_CLIENT = row3.VILLE_CLIENT ;
client_tmp.PAYS_CLIENT = row3.PAYS_CLIENT ;
client_tmp.REGION_CLIENT = row3.REGION_CLIENT ;
client_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
client_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
client = client_tmp;
} // closing inner join bracket (1)
// ###### START REJECTS ##### 

// # Output reject table : 'TypeClientInnexistant'
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
TypeClientInnexistant_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
TypeClientInnexistant_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
TypeClientInnexistant_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE ;
TypeClientInnexistant_tmp.LB_LIGNE_REJET = row3.ID_CLIENT  +'|'+row3.NOM_CLIENT  +'|'+row3.PREN_CLIENT +'|'+ row3.CD_POSTAL_CLIENT +'|'+ row3.VILLE_CLIENT +'|'+ row3.PAYS_CLIENT +'|'+  row3.REGION_CLIENT +'|'+ row3.CD_TYPE_CLIENT ;
TypeClientInnexistant_tmp.LB_MESSAGE_REJET = "Depandance ==> le type client: " +row3.CD_TYPE_CLIENT + " n'existe pas";
TypeClientInnexistant_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
TypeClientInnexistant_tmp.DT_REJET = TalendDate.getCurrentDate();
TypeClientInnexistant_tmp.LB_JOB_NAME = jobName;
TypeClientInnexistant = TypeClientInnexistant_tmp;
...
!client.NOM_CLIENT.equals(row7.NOM_CLIENT) || !client.PREN_CLIENT.equals(row7.PREN_CLIENT)|| !client.CD_POSTAL_CLIENT.equals(row7.CD_POSTAL_CLIENT) || !client.VILLE_CLIENT.equals(row7.VILLE_CLIENT) || !client.PAYS_CLIENT.equals(row7.PAYS_CLIENT)|| ! client.REGION_CLIENT.equals(row7.REGION_CLIENT) || !client.CD_TYPE_CLIENT.equals(row7.CD_TYPE_CLIENT)

 ) {
updateBICurrent_tmp.ID_CLIENT = null;
updateBICurrent_tmp.NOM_CLIENT = null;
updateBICurrent_tmp.PREN_CLIENT = null;
updateBICurrent_tmp.CD_POSTAL_CLIENT = null;
updateBICurrent_tmp.VILLE_CLIENT = null;
updateBICurrent_tmp.PAYS_CLIENT = null;
updateBICurrent_tmp.REGION_CLIENT = null;
updateBICurrent_tmp.CD_TYPE_CLIENT = null;
updateBICurrent_tmp.LB_NOM_FICHIER = null;
updateBICurrent_tmp.DT_INSERTION = null;
updateBICurrent_tmp.BL_LIGNE_ACTIVE = 0;
updateBICurrent_tmp.LB_JOB_NAME = null;
...
if(updateBICurrent != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(updateBICurrent.ID_CLIENT == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, updateBICurrent.ID_CLIENT);
}

                    if(updateBICurrent.NOM_CLIENT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, updateBICurrent.NOM_CLIENT);
}

                    if(updateBICurrent.PREN_CLIENT == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, updateBICurrent.PREN_CLIENT);
}

                    if(updateBICurrent.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, updateBICurrent.CD_POSTAL_CLIENT);
}

                    if(updateBICurrent.VILLE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, updateBICurrent.VILLE_CLIENT);
}

                    if(updateBICurrent.PAYS_CLIENT == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, updateBICurrent.PAYS_CLIENT);
}

                    if(updateBICurrent.REGION_CLIENT == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, updateBICurrent.REGION_CLIENT);
}

                    if(updateBICurrent.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, updateBICurrent.CD_TYPE_CLIENT);
}

                    if(updateBICurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, updateBICurrent.LB_NOM_FICHIER);
}

                    if(updateBICurrent.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(updateBICurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(11, updateBICurrent.BL_LIGNE_ACTIVE);

                    if(updateBICurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(12, updateBICurrent.LB_JOB_NAME);
}
...
// Start of branch "TypeClientInnexistant"
if(TypeClientInnexistant != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(TypeClientInnexistant.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, TypeClientInnexistant.LB_CHEMIN_FICHIER);
}

                    if(TypeClientInnexistant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, TypeClientInnexistant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, TypeClientInnexistant.NUM_LIGNE_REJET);

                    if(TypeClientInnexistant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, TypeClientInnexistant.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_6 > 0) {
                        if(TypeClientInnexistant.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(1, TypeClientInnexistant.LB_MESSAGE_REJET);
}

                        if(TypeClientInnexistant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(2, TypeClientInnexistant.LB_NOM_FLUX);
}

                        if(TypeClientInnexistant.DT_REJET != null) {
pstmtUpdate_tDBOutput_6.setTimestamp(3, new java.sql.Timestamp(TypeClientInnexistant.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_6.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(TypeClientInnexistant.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(4, TypeClientInnexistant.LB_JOB_NAME);
}

                        if(TypeClientInnexistant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(5 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(5 + count_tDBOutput_6, TypeClientInnexistant.LB_CHEMIN_FICHIER);
}

                        if(TypeClientInnexistant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(6 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(6 + count_tDBOutput_6, TypeClientInnexistant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_6.setInt(7 + count_tDBOutput_6, TypeClientInnexistant.NUM_LIGNE_REJET);

                        if(TypeClientInnexistant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_6.setNull(8 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(8 + count_tDBOutput_6, TypeClientInnexistant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_6.setString(1, TypeClientInnexistant.LB_CHEMIN_FICHIER);
}

                        if(TypeClientInnexistant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(2, TypeClientInnexistant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_6.setInt(3, TypeClientInnexistant.NUM_LIGNE_REJET);

                        if(TypeClientInnexistant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(4, TypeClientInnexistant.LB_LIGNE_REJET);
}

                        if(TypeClientInnexistant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(5, TypeClientInnexistant.LB_MESSAGE_REJET);
}

                        if(TypeClientInnexistant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(6, TypeClientInnexistant.LB_NOM_FLUX);
}

                        if(TypeClientInnexistant.DT_REJET != null) {
pstmtInsert_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(TypeClientInnexistant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_6.setString(8, TypeClientInnexistant.LB_JOB_NAME);
}
...
} // End of branch "TypeClientInnexistant"
...
insertRejet_tmp.LB_LIGNE_REJET = row5.ID_CLIENT+'|'+row5.NOM_CLIENT+'|'+row5.PREN_CLIENT+'|'+row5.CD_POSTAL_CLIENT+'|'+row5.VILLE_CLIENT+'|'+row5.PAYS_CLIENT+'|'+row5.REGION_CLIENT+'|'+row5.CD_TYPE_CLIENT ;
 ...
 */
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"TypeClientInnexistant");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(row3,row4) outputs:(client,TypeClientInnexistant)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(client,row7) outputs:(insertClient,updateBICurrent,insertNewClient)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsClient.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jodsclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     421662 characters generated by Talend Open Studio for Data Integration 
