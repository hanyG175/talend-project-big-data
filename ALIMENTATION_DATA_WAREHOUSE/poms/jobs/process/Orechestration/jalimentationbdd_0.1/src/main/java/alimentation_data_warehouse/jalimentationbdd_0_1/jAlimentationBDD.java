...
package alimentation_data_warehouse.jalimentationbdd_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jAlimentationBDD) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		alimentation_data_warehouse.jchargeods_0_1.jChargeODS childJob_tRunJob_1 = new alimentation_data_warehouse.jchargeods_0_1.jChargeODS();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		alimentation_data_warehouse.jchargedwh_0_1.jChargeDWH childJob_tRunJob_2 = new alimentation_data_warehouse.jchargedwh_0_1.jChargeDWH();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jAlimentationBDD.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jalimentationbdd_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     113480 characters generated by Talend Open Studio for Data Integration 
