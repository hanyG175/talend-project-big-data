...
package alimentation_data_warehouse.jchargeods_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jChargeODS = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeODS, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jChargeODS) {
 ...
 */
	...
	System.err.println("le repertiore du jour n'existe pas");
	
	globalMap.put("tDie_1_DIE_MESSAGE", "le repertiore du jour n'existe pas");
	globalMap.put("tDie_1_DIE_MESSAGES", "le repertiore du jour n'existe pas");
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		alimentation_data_warehouse.jodscategorie_0_1.jOdsCategorie childJob_tRunJob_1 = new alimentation_data_warehouse.jodscategorie_0_1.jOdsCategorie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_2 = null;
		...
		alimentation_data_warehouse.jodssouscategorie_0_1.jOdsSousCategorie childJob_tRunJob_2 = new alimentation_data_warehouse.jodssouscategorie_0_1.jOdsSousCategorie();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		alimentation_data_warehouse.jodsproduit_0_1.jOdsProduit childJob_tRunJob_3 = new alimentation_data_warehouse.jodsproduit_0_1.jOdsProduit();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_4 = null;
		...
		alimentation_data_warehouse.jodstypeclient_0_1.jOdsTypeClient childJob_tRunJob_4 = new alimentation_data_warehouse.jodstypeclient_0_1.jOdsTypeClient();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_5 = null;
		...
		alimentation_data_warehouse.jodsclient_0_1.jOdsClient childJob_tRunJob_5 = new alimentation_data_warehouse.jodsclient_0_1.jOdsClient();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		alimentation_data_warehouse.jodsvente_0_1.jOdsVente childJob_tRunJob_6 = new alimentation_data_warehouse.jodsvente_0_1.jOdsVente();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jChargeODS.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jchargeods_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     158280 characters generated by Talend Open Studio for Data Integration 
