...
package alimentation_data_warehouse.jodssouscategorie_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsSousCategorie) {
...
CATEGORIE_tmp.LB_SOUS_CATEGORIE = row1.LB_SOUS_CATEGORIE ;
...
!CATEGORIE.CD_CATEGORIE.isEmpty() && !CATEGORIE.LB_SOUS_CATEGORIE.isEmpty()	&& !CATEGORIE.CD_SOUS_CATEGORIE.isEmpty()		), "advanced condition failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.LB_SOUS_CATEGORIE = CATEGORIE.LB_SOUS_CATEGORIE;
      ...
      nb_line_ok_tFilterRow_1++;
            ...
            if (row5 == null){
              row5 = new row5Struct();
                ...
                row5.LB_SOUS_CATEGORIE = CATEGORIE.LB_SOUS_CATEGORIE;
...
if(row2.CD_SOUS_CATEGORIE == null){
	...
	row3 = new row3Struct();
}row3.CD_CATEGORIE = row2.CD_CATEGORIE;			row3.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE;			row3.LB_SOUS_CATEGORIE = row2.LB_SOUS_CATEGORIE;			row3.NUM_LIGNE = row2.NUM_LIGNE;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row6 == null){ 
	
	row6 = new row6Struct();
}				row6.CD_CATEGORIE = row2.CD_CATEGORIE;			row6.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE;			row6.LB_SOUS_CATEGORIE = row2.LB_SOUS_CATEGORIE;			row6.NUM_LIGNE = row2.NUM_LIGNE;			
...
categorieManquant_tmp.LB_LIGNE_REJET = row3.CD_SOUS_CATEGORIE+'|'+row3.LB_SOUS_CATEGORIE ;
categorieManquant_tmp.LB_MESSAGE_REJET = "Depandance ==> la categorie: "+row3.CD_CATEGORIE+"n'existe pas" ;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_SOUS_CATEGORIE = sousCategorie.CD_SOUS_CATEGORIE ;
...
!sousCategorie.LB_SOUS_CATEGORIE.equals(row7.LB_SOUS_CATEGORIE) || !sousCategorie.CD_CATEGORIE.equals(row7.CD_CATEGORIE)

 ) {
updateBICurrent_tmp.CD_SOUS_CATEGORIE = sousCategorie.CD_SOUS_CATEGORIE ;
updateBICurrent_tmp.LB_SOUS_CATEGORIE = null;
updateBICurrent_tmp.CD_CATEGORIE = null;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
insertSousCategorie_tmp.CD_SOUS_CATEGORIE = sousCategorie.CD_SOUS_CATEGORIE ;
insertSousCategorie_tmp.LB_SOUS_CATEGORIE = sousCategorie.LB_SOUS_CATEGORIE ;
insertSousCategorie_tmp.CD_CATEGORIE = sousCategorie.CD_CATEGORIE ;
...
} else {pstmt_tDBOutput_3.setString(1, insertSousCategorie.CD_SOUS_CATEGORIE);
}

                    if(insertSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, insertSousCategorie.LB_SOUS_CATEGORIE);
}

                    if(insertSousCategorie.CD_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, insertSousCategorie.CD_CATEGORIE);
}

                    if(insertSousCategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, insertSousCategorie.LB_NOM_FICHIER);
}

                    if(insertSousCategorie.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(5, new java.sql.Timestamp(insertSousCategorie.DT_INSERTION.getTime()));
} else {
...
} else {pstmt_tDBOutput_3.setString(7, insertSousCategorie.LB_JOB_NAME);
}
...
if(updateBICurrent != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(updateBICurrent.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, updateBICurrent.LB_SOUS_CATEGORIE);
}

                    if(updateBICurrent.CD_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, updateBICurrent.CD_CATEGORIE);
}

                    if(updateBICurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, updateBICurrent.LB_NOM_FICHIER);
}

                    if(updateBICurrent.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(updateBICurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(5, updateBICurrent.BL_LIGNE_ACTIVE);

                    if(updateBICurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, updateBICurrent.LB_JOB_NAME);
}

                    if(updateBICurrent.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(7 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7 + count_tDBOutput_2, updateBICurrent.CD_SOUS_CATEGORIE);
}
...
insertDuplicate_tmp.LB_LIGNE_REJET = row6.CD_SOUS_CATEGORIE+'|'+row6.LB_SOUS_CATEGORIE+row6.CD_CATEGORIE ;
...
insertRejet_tmp.LB_LIGNE_REJET = row5.CD_SOUS_CATEGORIE+'|'+row5.LB_SOUS_CATEGORIE +row5.CD_CATEGORIE ;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(sousCategorie,row7) outputs:(insertSousCategorie,updateBICurrent,insertNewValueSousCategorie)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsSousCategorie.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jodssouscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     391807 characters generated by Talend Open Studio for Data Integration 
