...
package alimentation_data_warehouse.jodsproduit_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsProduit) {
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"NOM_PRODUIT\" = ?,\"PRIX_ACHAT_PRODUIT\" = ?,\"PRIX_VENTE_PRODUIT\" = ?,\"CD_SOUS_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_PRODUIT\" = ?";
...
CATEGORIE_tmp.CD_SOUS_CATEGORIE = row1.CD_SOUS_CATEGORIE ;
CATEGORIE_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1) ;
CATEGORIE_tmp.CD_PRODUIT = row1.CD_PRODUIT ;
CATEGORIE_tmp.NOM_PRODUIT = row1.NOM_PRODUIT ;
CATEGORIE_tmp.PRIX_ACHAT_PRODUIT = row1.PRIX_ACHAT_PRODUIT ;
CATEGORIE_tmp.PRIX_VENTE_PRODUIT = row1.PRIX_VENTE_PRODUIT ;
...
!CATEGORIE.CD_PRODUIT.isEmpty() && !CATEGORIE.NOM_PRODUIT.isEmpty() && !CATEGORIE.CD_SOUS_CATEGORIE.isEmpty() && CATEGORIE.PRIX_ACHAT_PRODUIT != null && CATEGORIE.PRIX_VENTE_PRODUIT != null), "advanced condition failed");
    
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
                row2 = new row2Struct();
              }
               row2.CD_SOUS_CATEGORIE = CATEGORIE.CD_SOUS_CATEGORIE;
               row2.NUM_LIGNE = CATEGORIE.NUM_LIGNE;
               row2.CD_PRODUIT = CATEGORIE.CD_PRODUIT;
               row2.NOM_PRODUIT = CATEGORIE.NOM_PRODUIT;
               row2.PRIX_ACHAT_PRODUIT = CATEGORIE.PRIX_ACHAT_PRODUIT;
               row2.PRIX_VENTE_PRODUIT = CATEGORIE.PRIX_VENTE_PRODUIT;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.CD_SOUS_CATEGORIE = CATEGORIE.CD_SOUS_CATEGORIE;
                row5.NUM_LIGNE = CATEGORIE.NUM_LIGNE;
                row5.CD_PRODUIT = CATEGORIE.CD_PRODUIT;
                row5.NOM_PRODUIT = CATEGORIE.NOM_PRODUIT;
                row5.PRIX_ACHAT_PRODUIT = CATEGORIE.PRIX_ACHAT_PRODUIT;
                row5.PRIX_VENTE_PRODUIT = CATEGORIE.PRIX_VENTE_PRODUIT;
...
if(row2.CD_PRODUIT == null){
	...
	row3 = new row3Struct();
}row3.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE;			row3.NUM_LIGNE = row2.NUM_LIGNE;			row3.CD_PRODUIT = row2.CD_PRODUIT;			row3.NOM_PRODUIT = row2.NOM_PRODUIT;			row3.PRIX_ACHAT_PRODUIT = row2.PRIX_ACHAT_PRODUIT;			row3.PRIX_VENTE_PRODUIT = row2.PRIX_VENTE_PRODUIT;					
		nb_uniques_tUniqRow_1++;
	} else {
if(row6 == null){ 
	
	row6 = new row6Struct();
}				row6.CD_SOUS_CATEGORIE = row2.CD_SOUS_CATEGORIE;			row6.NUM_LIGNE = row2.NUM_LIGNE;			row6.CD_PRODUIT = row2.CD_PRODUIT;			row6.NOM_PRODUIT = row2.NOM_PRODUIT;			row6.PRIX_ACHAT_PRODUIT = row2.PRIX_ACHAT_PRODUIT;			row6.PRIX_VENTE_PRODUIT = row2.PRIX_VENTE_PRODUIT;			
...
sousCategorie_tmp.NOM_PRODUIT = row3.NOM_PRODUIT ;
sousCategorie_tmp.PRIX_ACHAT_PRODUIT = row3.PRIX_ACHAT_PRODUIT ;
sousCategorie_tmp.PRIX_VENTE_PRODUIT = row3.PRIX_VENTE_PRODUIT ;
...
categorieManquant_tmp.LB_LIGNE_REJET = row3.CD_SOUS_CATEGORIE+'|'+row3.NUM_LIGNE+'|'+row3.PRIX_ACHAT_PRODUIT+'|'+row3.PRIX_VENTE_PRODUIT+'|'+row3.NOM_PRODUIT ;
categorieManquant_tmp.LB_MESSAGE_REJET = "Depandance ==> la categorie: "+row3.CD_SOUS_CATEGORIE+"n'existe pas" ;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_PRODUIT = sousCategorie.CD_PRODUIT ;
...
!sousCategorie.NOM_PRODUIT.equals(row7.NOM_PRODUIT) || !sousCategorie.CD_SOUS_CATEGORIE.equals(row7.CD_SOUS_CATEGORIE) || sousCategorie.PRIX_ACHAT_PRODUIT.compareTo(row7.PRIX_ACHAT_PRODUIT)!=0 || sousCategorie.PRIX_VENTE_PRODUIT.compareTo(row7.PRIX_VENTE_PRODUIT)!=0

 ) {
updateBICurrent_tmp.CD_PRODUIT = sousCategorie.CD_PRODUIT ;
updateBICurrent_tmp.NOM_PRODUIT = null;
updateBICurrent_tmp.PRIX_ACHAT_PRODUIT = null;
updateBICurrent_tmp.PRIX_VENTE_PRODUIT = null;
updateBICurrent_tmp.CD_SOUS_CATEGORIE = null;
...
insertNewProduit_tmp.CD_PRODUIT = sousCategorie.CD_PRODUIT ;
insertNewProduit_tmp.NOM_PRODUIT = sousCategorie.NOM_PRODUIT ;
insertNewProduit_tmp.PRIX_ACHAT_PRODUIT = sousCategorie.PRIX_ACHAT_PRODUIT ;
insertNewProduit_tmp.PRIX_VENTE_PRODUIT = sousCategorie.PRIX_VENTE_PRODUIT ;
insertNewProduit_tmp.CD_SOUS_CATEGORIE = sousCategorie.CD_SOUS_CATEGORIE ;
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_5 ) {
insertProduit_tmp.CD_PRODUIT = sousCategorie.CD_PRODUIT ;
insertProduit_tmp.NOM_PRODUIT = sousCategorie.NOM_PRODUIT ;
insertProduit_tmp.PRIX_ACHAT_PRODUIT = sousCategorie.PRIX_ACHAT_PRODUIT ;
insertProduit_tmp.PRIX_VENTE_PRODUIT = sousCategorie.PRIX_VENTE_PRODUIT ;
insertProduit_tmp.CD_SOUS_CATEGORIE = sousCategorie.CD_SOUS_CATEGORIE ;
...
if(updateBICurrent != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(updateBICurrent.NOM_PRODUIT == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, updateBICurrent.NOM_PRODUIT);
}

                    pstmt_tDBOutput_2.setBigDecimal(2, updateBICurrent.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_2.setBigDecimal(3, updateBICurrent.PRIX_VENTE_PRODUIT);

                    if(updateBICurrent.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, updateBICurrent.CD_SOUS_CATEGORIE);
}

                    if(updateBICurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, updateBICurrent.LB_NOM_FICHIER);
}

                    if(updateBICurrent.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(6, new java.sql.Timestamp(updateBICurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(7, updateBICurrent.BL_LIGNE_ACTIVE);

                    if(updateBICurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, updateBICurrent.LB_JOB_NAME);
}

                    if(updateBICurrent.CD_PRODUIT == null) {
pstmt_tDBOutput_2.setNull(9 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9 + count_tDBOutput_2, updateBICurrent.CD_PRODUIT);
}
...
} else {pstmt_tDBOutput_6.setString(1, insertNewProduit.CD_PRODUIT);
}

                    if(insertNewProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, insertNewProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_6.setBigDecimal(3, insertNewProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_6.setBigDecimal(4, insertNewProduit.PRIX_VENTE_PRODUIT);

                    if(insertNewProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(5, insertNewProduit.CD_SOUS_CATEGORIE);
}

                    if(insertNewProduit.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(6, insertNewProduit.LB_NOM_FICHIER);
}

                    if(insertNewProduit.DT_INSERTION != null) {
pstmt_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(insertNewProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_6.setNull(7, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_6.setInt(8, insertNewProduit.BL_LIGNE_ACTIVE);

                    if(insertNewProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_6.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(9, insertNewProduit.LB_JOB_NAME);
}
...
insertDuplicate_tmp.LB_LIGNE_REJET = row6.CD_SOUS_CATEGORIE+'|'+row6.CD_PRODUIT ;
...
insertRejet_tmp.LB_LIGNE_REJET = row5.CD_SOUS_CATEGORIE+'|'+row5.CD_PRODUIT ;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(sousCategorie,row7) outputs:(insertProduit,updateBICurrent,insertNewProduit)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsProduit.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jodsproduit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     409671 characters generated by Talend Open Studio for Data Integration 
 *     on the June 5, 2025 at 1:18:23 PM BST
 ************************************************************************************************/