...
package alimentation_data_warehouse.jodscategorie_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jOdsCategorie) {
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"CD_CATEGORIE\",\"LB_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?)";
...
UpdateBICurrent_tmp.LB_CATEGORIE = null;
...
if(UpdateBICurrent != null) { 
	...
	currentComponent="tDBOutput_3";
        ...
        whetherReject_tDBOutput_3 = false;
                    if(UpdateBICurrent.LB_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(1, UpdateBICurrent.LB_CATEGORIE);
}

                    if(UpdateBICurrent.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, UpdateBICurrent.LB_NOM_FICHIER);
}

                    if(UpdateBICurrent.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(3, new java.sql.Timestamp(UpdateBICurrent.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(4, UpdateBICurrent.BL_LIGNE_ACTIVE);

                    if(UpdateBICurrent.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, UpdateBICurrent.LB_JOB_NAME);
}

                    if(UpdateBICurrent.CD_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(6 + count_tDBOutput_3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6 + count_tDBOutput_3, UpdateBICurrent.CD_CATEGORIE);
}
...
insertRejet_tmp.LB_LIGNE_REJET = row5.CD_CATEGORIE+'|'+row5.LB_CATEGORIE ;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jOdsCategorie.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jodscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     318796 characters generated by Talend Open Studio for Data Integration 
 *     on the June 5, 2025 at 1:18:22 PM BST
 ************************************************************************************************/