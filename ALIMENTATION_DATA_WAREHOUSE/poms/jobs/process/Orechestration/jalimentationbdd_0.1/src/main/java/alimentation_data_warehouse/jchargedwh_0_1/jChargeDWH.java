...
package alimentation_data_warehouse.jchargedwh_0_1;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH = new byte[0];
    static byte[] commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH.length) {
				if(length < 1024 && commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH.length == 0) {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH = new byte[1024];
				} else {
   					commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH, 0, length);
			strReturn = new String(commonByteArray_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ALIMENTATION_DATA_WAREHOUSE_jChargeDWH) {
...
globalMap.put("tDBConnection_1_ERROR_MESSAGE",e_tDBConnection_1.getMessage());
			...
			String sharedConnectionName_tDBConnection_1 = "VENTE ODS";
...
globalMap.put("tDBConnection_2_ERROR_MESSAGE",e_tDBConnection_2.getMessage());
			...
			String sharedConnectionName_tDBConnection_2 = "VENTE DWH";
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		alimentation_data_warehouse.jdwhproduit_0_1.jDwhProduit childJob_tRunJob_3 = new alimentation_data_warehouse.jdwhproduit_0_1.jDwhProduit();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		alimentation_data_warehouse.jdwhclient_0_1.jDwhClient childJob_tRunJob_1 = new alimentation_data_warehouse.jdwhclient_0_1.jDwhClient();
	    // pass DataSources
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		alimentation_data_warehouse.jdwhvente_0_1.jDwhVente childJob_tRunJob_6 = new alimentation_data_warehouse.jdwhvente_0_1.jDwhVente();
	    // pass DataSources
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jChargeDWH.class.getClassLoader().getResourceAsStream("alimentation_data_warehouse/jchargedwh_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     123058 characters generated by Talend Open Studio for Data Integration 
